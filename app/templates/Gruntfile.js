    ...
    sass: {
      ...
      dist: {
        files: [{
          ...
          src: ['*.{scss,sass}','plugins/*.{scss,sass}'],
          dest: '.tmp/styles',
          ext: '.css'
        }]
      },
      ...
      dist: {
        files: {
          '<%%= config.dist %>/styles/main.css': [
           ...
           '<%%= config.dist %>/styles/medium.css': [
            '.tmp/styles/medium.css'
           ],
           '<%%= config.dist %>/styles/wide.css': [
            '.tmp/styles/wide.css'
           ],
           '<%%= config.dist %>/styles/plugins.css': [
            '.tmp/styles/plugins.css'
           ]
         }
       }
     },
